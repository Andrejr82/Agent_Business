...
SOURCE_DIR_CLEANED = "data/parquet"
...
file_admat_semvendas = os.path.join(
    SOURCE_DIR_CLEANED, "ADMAT_SEMVENDAS_structured.parquet"
)
...
try:
    ...
    master_df = pd.concat(
        [df_admmatao, df_admat, df_admat_semvendas], ignore_index=True
    )
