    ...
    for tabela in tabelas_teste:
        ...
        try:
            ...
            if mes_cols:
                ...
                print(f"  ⚠️  Nenhuma coluna de mês encontrada")
            ...
            if codigo_cols:
                ...
                if not produto_59294.empty:
                    print(f"  ✅ Produto 59294 encontrado: {len(produto_59294)} registros")
                    
                    # Mostrar dados do produto
                    print(f"    Primeiras colunas do produto:")
                    ...
                    print(f"  ⚠️  Produto 59294 não encontrado nessa tabela")
